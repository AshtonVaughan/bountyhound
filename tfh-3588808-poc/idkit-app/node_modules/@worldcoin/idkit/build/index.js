...
var QRPlaceholderIcon = (props) => /* @__PURE__ */ jsxs8("svg", { ...props, xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 200 200", children: [
  /* @__PURE__ */ jsx13(
    "path",
    {
      fill: "#EBECEF",
  ...
  /* @__PURE__ */ jsx13("defs", { children: /* @__PURE__ */ jsxs8("linearGradient", { id: "a", x1: "0", x2: "200", y1: "0", y2: "200", gradientUnits: "userSpaceOnUse", children: [
    /* @__PURE__ */ jsx13("stop", { offset: ".37", stopColor: "#fff", stopOpacity: "0" }),
    /* @__PURE__ */ jsx13("stop", { offset: ".5", stopColor: "#fff", stopOpacity: ".85" }),
    /* @__PURE__ */ jsx13("stop", { offset: ".63", stopColor: "#fff", stopOpacity: "0" })
  ] }) })
] });
    ...
    (media == "desktop" || showQR) && /* @__PURE__ */ jsxs9(Fragment2, { children: [
      /* @__PURE__ */ jsx14(AnimatePresence, { children: copiedLink && /* @__PURE__ */ jsx14(
        motion.div,
        {
          ...
          children: /* @__PURE__ */ jsx14("span", { className: "rounded-lg border border-f1f5f8 px-2 py-1 text-sm", children: __("QR Code copied") })
        },
        "copied"
      ) }),
      /* @__PURE__ */ jsx14("div", { className: "relative inline-flex items-center justify-center rounded-2xl border border-f1f5f8 p-2 dark:border-f1f5f8/10", children: /* @__PURE__ */ jsx14("div", { className: "text-29343f dark:text-white", children: qrData ? (
...
var LoadingIcon = ({ className, ...props }) => /* @__PURE__ */ jsxs10(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    fill: "none",
    ...
    ...props,
    children: [
      /* @__PURE__ */ jsx15("circle", { cx: "12", cy: "12", r: "10.75", stroke: "#191C20", strokeOpacity: ".16", strokeWidth: "2.5" }),
      /* @__PURE__ */ jsx15(
        "path",
        {
          fill: "#191C20",
...
var WorldIDState = () => {
  ...
  return /* @__PURE__ */ jsxs11("div", { className: "-mt-6 space-y-10", children: [
    /* @__PURE__ */ jsxs11("div", { children: [
      /* @__PURE__ */ jsx16("div", { className: "mb-4 flex items-center justify-center", children: /* @__PURE__ */ jsx16(WorldcoinIcon_default, { className: "h-10 text-0d151d dark:text-white" }) }),
      /* @__PURE__ */ jsx16("p", { className: "text-center font-sora text-2xl font-semibold text-gray-900 dark:text-white", children: __("Verify with World ID") }),
      /* @__PURE__ */ jsx16("p", { className: "mt-3 text-center text-657080 dark:text-9eafc0 md:mt-2", children: "Please use your World App to scan the QR code" })
    ] }),
    /* @__PURE__ */ jsxs11("div", { className: "relative", children: [
      verificationState == VerificationState.WaitingForApp && /* @__PURE__ */ jsxs11("div", { className: "absolute inset-0 flex flex-col items-center justify-center space-y-6", children: [
        /* @__PURE__ */ jsx16(LoadingIcon_default, { className: "h-6 w-6" }),
        /* @__PURE__ */ jsxs11("div", { children: [
          /* @__PURE__ */ jsx16("p", { className: "font-bold text-657080", children: "Verifying" }),
          /* @__PURE__ */ jsx16("p", { className: "text-sm text-657080", children: "Please continue in app" })
        ] })
      ] }),
      /* @__PURE__ */ jsx16(
        "div",
        {
          ...
          children: /* @__PURE__ */ jsx16(QRState_default, { showQR, setShowQR, qrData: connectorURI })
        }
      )
    ] })
  ] });
...
var HostAppVerificationState = () => {
  return /* @__PURE__ */ jsxs12("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsx18("div", { className: "flex justify-center", children: /* @__PURE__ */ jsx18(LoadingIcon_default, { className: "h-24 w-24" }) }),
    /* @__PURE__ */ jsx18("div", { className: "text-70868f mt-4", children: __("Transmitting verification to host app. Please wait...") })
  ] });
};
...
var IDKitWidget = ({ children, ...config }) => {
  ...
  return /* @__PURE__ */ jsxs13(Dialog.Root, { open: isOpen, onOpenChange, children: [
